...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20251025_nonnaromagnola_f424dbdc669df0897520_20251030084213_archive.zip';
        const ARCHIVE_SIZE       = '70941172';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f424dbd-30084213';
        const SECONDARY_PACKAGE_HASH = '457b15c-30084213';
